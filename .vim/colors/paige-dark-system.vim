...
let g:colors_name = "paige-dark-system"
...
let s:default_text            = [   '0',   '7',          '', '#080808', '#ffffff',          '' ]
let s:default_text_bold       = [   '0',   '7',      'bold', '#080808', '#ffffff',      'bold' ]
let s:default_text_italic     = [   '0',   '7',    'italic', '#080808', '#ffffff',    'italic' ]
let s:default_text_underline  = [   '0',   '7', 'underline', '#080808', '#ffffff', 'underline' ]

let s:alt_fg_text             = [   '0', '238',          '', '#080808', '#444444',          '' ]
let s:alt_fg_text_none        = [   '0', '238',      'none', '#080808', '#444444',      'none' ]
let s:alt_fg_text_2           = [   '0', '248',          '', '#080808', '#a8a8a8',          '' ]

let s:alt_bg_text             = [ '235',   '7',          '', '#262626', '#ffffff',          '' ]
let s:alt_bg_text_bold        = [ '235',   '7',      'bold', '#262626', '#ffffff',      'bold' ]
let s:alt_bg_text_italic      = [ '235',   '7',    'italic', '#262626', '#ffffff',    'italic' ]
let s:alt_bg_text_underline   = [ '235',   '7', 'underline', '#262626', '#ffffff', 'underline' ]
let s:alt_bg_text_no_override = [ '235',    '',      'none', '#262626',        '',      'none' ]
let s:alt_bg_text_none        = [ '235',   '7',      'none', '#262626', '#ffffff',      'none' ]
let s:alt_bg_no_fg            = [ '235', '235',      'none', '#262626', '#e4e4e4',      'none' ]

let s:green_bg_text           = [ '106',   '7',          '', '#87af00', '#ffffff',          '' ]
let s:red_bg_text             = [ '160',   '7',          '', '#d70000', '#ffffff',          '' ]
let s:yellow_bg_text          = [ '178',   '7',          '', '#d7af00', '#ffffff',          '' ]
let s:blue_bg_text            = [  '39',   '7',          '', '#00afff', '#ffffff',          '' ]
let s:purple_bg_text_none     = [ '141',   '7',      'none', '#af87ff', '#ffffff',      'none' ]
let s:alt_purple_bg_text_none = [ '139',   '7',      'none', '#af87af', '#ffffff',      'none' ]

let s:red_fg_text             = [   '0', '196',          '', '#080808', '#ff0000',          '' ]
let s:green_fg_text           = [   '0',  '34',          '', '#080808', '#00af00',          '' ]
let s:blue_fg_text            = [   '0',  '27',          '', '#080808', '#005fff',          '' ]
let s:blue_fg_text_underline  = [   '0',  '27', 'underline', '#080808', '#005fff', 'underline' ]

let s:menu_select             = [  '70',   '7',      'bold', '#5faf00', '#ffffff',          '' ]
let s:menu_no_select          = [ '240',   '7',          '', '#585858', '#ffffff',          '' ]
